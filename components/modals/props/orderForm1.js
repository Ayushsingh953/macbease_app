...
import { row_even, center, border } from "../../../constants/styles";

const { width, height } = Dimensions.get("window");
const options1 = ["today", "tomorrow", "thirdDay"];
              ...
              <View style={[{ flex: 1 }, row_even]} key={index}>
                ...
                <View>
                  <Text
                    style={[
                      styles.options,
                      day === item ? { color: "#444" } : { color: "#85888a" },
                    ]}
                  >
                    {item}
                  </Text>
                ...
                <View>
                  <Text
                    style={[
                      ...
                      time === item ? { color: "#444" } : { color: "#85888a" },
                    ]}
                  >
                    {item}
                  </Text>
