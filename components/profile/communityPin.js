...
import { colorsCommunity } from "../../constants/profile-data";
      ...
      <View style={{ flexDirection: "row", marginLeft: 18 }}>
        ...
        <View>
          <View style={{ flexDirection: "row" }}>
            <Text style={{ fontWeight: "bold", marginLeft: 12, fontSize: 20 }}>
              {data.communityName}
            </Text>
            <MaterialIcons name="verified" size={16} color="#1ea1ed" />
          </View>
          <Text style={{ fontWeight: "bold", color: "#444", marginLeft: 12 }}>
            Posted {data.time} ago
          </Text>
        </View>
      </View>
        ...
        <View style={{ width: "80%" }}>
          ...
          <View style={styles.icon}>
            <View style={styles.iconSub}>
              <View style={[styles.iconWrapper, { paddingLeft: 8 }]}>
                <EvilIcons
                  name="comment"
                  size={28}
