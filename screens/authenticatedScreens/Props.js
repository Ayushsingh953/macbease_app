...
import data from "../../constants/prop_data";
import Prop from "../../components/modals/props/prop";
import { center, ios_shadow } from "../../constants/styles";
import OrderForm1 from "../../components/modals/props/orderForm1";
import ChooseSlots from "../../components/modals/props/chooseSlots";
import HistoryModal from "../../components/modals/props/prop_history";
import PropSearching from "../../components/modals/props/propSearching";
import OtpModal from "../../components/modals/props/otpModal";
import NotFound from "../../components/modals/props/notFound";
import PaymentModal from "../../components/modals/props/paymentModal";
import CreditModal from "../../components/modals/props/creditModal";
...
const Credit = ({ setCreditModal }) => {
  return (
    ...
    >
      <Entypo name="credit-card" size={22} color="#444" />
    </Pressable>
  );
};
...
export default function Props() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Credit setCreditModal={setCreditModal} />
      ...
      <Modal visible={creditModal} animationType="slide" transparent={true}>
        <CreditModal setCreditModal={setCreditModal} />
      </Modal>
    </View>
  );
}
...
const getCorrectModal = (
  ...
  switch (modalState) {
    case "orderForm":
      async function handleProceedEvent() {
        if (day && time) {
          ...
          if (time === "Night") {
            ...
            try {
              const res = await axios.post(
                `${URL}/props/nightBookingAvailability`,
                data,
                config
              );
              console.log("Night booking response " + res.data);
              if (res.data.propId === undefined) {
                setModalState("notFound");
                return;
              }
              // console.log(res.data.propId);
