...
import { prompts } from "../../constants/profile-data";
    ...
    <SafeAreaView>
      <View style={styles.title}>
        ...
        <Text style={styles.heading}>
          College is all about meeting right person, one who will go with you
          all the way. We at Macbease help you find that person. Our ai model
          maps your search keyword to most relevant cards published so that you
        ...
        <Text
          style={[
            styles.heading,
            { marginTop: SPACING, marginBottom: 2 * SPACING },
          ]}
        >
