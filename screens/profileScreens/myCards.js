...
import { myCards, colors } from "../../constants/profile-data";
...
export default function MyCard({ navigation }) {
  ...
  useEffect(() => {
    ...
    async function getCards() {
      try {
        const res = await axios.post(`${URL}/card/getCardsOfUser`, config);
        console.log(res.data);
      } catch (err) {
        console.log(" fetching Cards error " + err);
      }
    }
    getCards();
  }, [isFocused]);
  ...
  return (
    <SafeAreaView>
      ...
      >
        <View>
          <Text style={[styles.hello, { color: "#444", marginLeft: SPACING }]}>
            Your chosen area of interest are
          </Text>
          <Pressable
            style={({ pressed }) => [
              pressed && { opacity: 0.5 },
        ...
        <Text
          style={[
            styles.hello,
            { color: "#444", marginLeft: SPACING, marginTop: SPACING },
          ]}
        >
          Your cards are
        </Text>
        ...
        >
          Still got {10 - myCards.cards.length} cards left. Let's compose
        </Text>
        <TextInput
          style={styles.input}
          multiline={true}
          ...
          maxLength={180}
        />
        <TextInput style={styles.tagInput} placeholder="Enter tag 1" />
        <TextInput style={styles.tagInput} placeholder="Enter tag 2" />
        <TextInput style={styles.tagInput} placeholder="Enter tag 3" />
