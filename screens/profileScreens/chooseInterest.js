...
import { interests } from "../../constants/profile-data";
...
export default function ChooseInterest({ navigation }) {
  ...
  async function handleSubmitEvent() {
    ...
    const data = {
      interests: selectedTile,
    };
    try {
      const res = await axios.post(`${URL}/card/saveInterest`, data, config);
